...
; all positive integers with no prime factors other than 2, 3, or 5. One obvious
; way to do this is to simply test each integer in turn to see whether it has any factors
; other than 2, 3, and 5. But this is very inefficient, since, as the integers get larger, 
