    ...
    (let ((the-ops
      ...
      (define (dispatch message)
        (cond ((eq? message 'start)
              ...
              ((eq? message 'chk-register) register-exists)
...
(define (set-register-contents! machine register-name value)
  (if (not (chk-register machine register-name))
      ((machine 'allocate-register) register-name))
  (set-contents! (get-register machine register-name) value)
  'done)
(define (get-register machine reg-name)
  (if (not (chk-register machine reg-name))
      ((machine 'allocate-register) reg-name))
  ((machine 'get-register) reg-name))

; add a method for checking register exists
(define (chk-register machine reg-name)
  ((machine 'chk-register) reg-name))
